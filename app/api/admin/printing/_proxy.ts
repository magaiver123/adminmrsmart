...
export async function callPrintingBackend(options: ProxyOptions) {
...
export function backendErrorResponse(result: { status: number; data: any }) {
  const error = result.data?.error || "Erro ao comunicar com o backend de impressao.";
